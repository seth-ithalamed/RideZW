...
export function AuthGate({ role = 'rider', children }: { role?: 'rider' | 'driver'; children: ReactNode }) {
    ...
    >
      ...
      >
        ...
        <View style={s.heroContainer}>
          ...
          <Text style={s.heroSubtitle}>Rider App & Real-Time Fare Negotiation</Text>
        </View>
            ...
            <View style={s.formSection}>
              ...
              {mode === 'signup' && (
                <>
                  ...
                  <View style={s.inputGroup}>
                    <Text style={s.inputLabel}>Primary City / Area</Text>
            ...
            <View style={s.otpSection}>
              ...
              >
                {submitting ? (
                  ...
                  <Text style={s.buttonText}>
                    {mode === 'signup' ? 'Verify & Create Rider Account' : 'Verify & Enter Rider Portal'}
                  </Text>
                )}
              </TouchableOpacity>
        ...
        <View style={s.footer}>
          ...
          <Text style={s.footerText}>RideZW Mobility Platform Zimbabwe • RIDER PORTAL</Text>
        </View>
      </ScrollView>
